    ...
    <header class="flex justify-between items-center p-4 bg-orange-950">
        ...
        <section class="flex justify-between items-center p-4 my-3 mx-3">
            <div class="flex items-center">
                <img class="max-h-52 rounded-full w-auto ml-1 md:ml-10" src="./asset/gojo.png" alt="toga">
                <div>
                    <p class="text-3xl font-semibold mt-2 ml-5 text-white ">Gojo Satoru</p>
                    <ul class="flex justify-normal items-start">
                        <li>
                            <p class="bg-blue-600 rounded max-w-max text-white ml-5 my-2 px-2">Fantasy</p>
                        </li>
                        <li>
                            <p class="bg-blue-600 rounded max-w-max text-white ml-2 my-2 px-2">Man</p>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <section class="flex justify-normal items-center p-4 my-3 mx-3">
            <div class="ml-6">
                <div class="rounded-t bg-orange-300">
                    <img class="max-h-96 w-auto rounded-t" src="./asset/gojo2.jpg" alt="">
                </div>
                <div class="bg-orange-800 rounded-b p-5 text-white">
                    <p>Size L</p>
                    <p class="text-xl"><b>Rp 120.000/day</b></p>
                </div>
            ...
            <div class="container max-w-[100vh] min-h-[80vh] justify-start items-start ml-12">
                ...
                <div class="border-2 border-orange-950 bg-orange-300 justify-start">
                    <ul class="flex justify-normal items-center">
                        <li>
                            <img class="max-h-28 w-auto m-1 rounded md:m-10" src="./asset/gojo.png" alt="">
                        </li>
                        <li>
