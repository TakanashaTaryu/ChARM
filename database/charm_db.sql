...
--
-- Host: localhost:3306
-- Generation Time: Oct 08, 2024 at 11:44 AM
...
CREATE TABLE `users` (
  `user_id` int UNSIGNED NOT NULL,
  `admin_value` int DEFAULT '0',
  `username` varchar(255) NOT NULL,
  `password` varchar(255) NOT NULL,
  `email` varchar(255) NOT NULL,
  `first_name` varchar(255) DEFAULT 'belum dimasukan',
  `last_name` varchar(255) DEFAULT 'belum dimasukan',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `users` (`user_id`, `admin_value`, `username`, `password`, `email`, `first_name`, `last_name`, `created_at`, `updated_at`) VALUES
(0, 0, '$username', '$password', '$email', 'belum dimasukan', 'belum dimasukan', '2024-10-01 07:04:44', '2024-10-02 07:09:55'),
(1, 1, 'admin', '$2y$10$53ac0Fp1cAk5Mv3ifrWuOOmmCzXPmXImLCtyuK3nteTANC45AbC2K', 'admin@gmail.com', 'belum dimasukan', 'belum dimasukan', '2024-10-02 07:09:21', '2024-10-02 07:10:12'),
(2, 0, 'aku', '$2y$10$y.1nP2Q8mZjrlIxC1eWaYuCAFL/h/NRNgxwTvbRIG0v282ebBiejy', 'aku@gmail.com', 'belum dimasukan', 'belum dimasukan', '2024-10-01 07:01:30', '2024-10-04 04:52:34'),
(18, 0, 'b', '$2y$10$1ArzVbWGCRfHdxYOzSKOt.ljpNghkcx3ChJGotig4xcTWGyIh4yzK', 'b@mail', 'belum dimasukan', 'belum dimasukan', '2024-10-02 08:40:56', '2024-10-02 08:40:56'),
(20, 0, 'fiqri', '$2y$10$ePS/ejGcfLg3UHFWhNyEte20lYZzYIer3gUzz06Mww2EWh6P1Fvhm', 'fiqrifirmansyah945@gmail.com', 'belum dimasukan', 'belum dimasukan', '2024-10-03 05:15:22', '2024-10-03 05:15:22'),
(21, 0, 'a', '$2y$10$2WZE8pE3hm6NoOlXOHRrVOR0fjhzwVxBcg2lahTLbntBKfqN3DW1G', 'fiqrifirmansyah15@gmail.com', 'belum dimasukan', 'belum dimasukan', '2024-10-03 05:20:00', '2024-10-03 05:20:00');
...
--
ALTER TABLE `midtrans`
  ADD CONSTRAINT `midtrans_ibfk_2` FOREIGN KEY (`payment_id`) REFERENCES `payment_details` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `midtrans_ibfk_3` FOREIGN KEY (`payment_url`) REFERENCES `payment_details` (`payment_url_API`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `payment_details`
  ...
  ADD CONSTRAINT `payment_details_ibfk_1` FOREIGN KEY (`status_code`) REFERENCES `midtrans` (`payment_status_code`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `payment_notif`
  ...
  ADD CONSTRAINT `payment_notif_ibfk_1` FOREIGN KEY (`payment_id`) REFERENCES `payment_details` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `payment_notif_ibfk_2` FOREIGN KEY (`status_code`) REFERENCES `midtrans` (`payment_status_code`) ON DELETE CASCADE ON UPDATE CASCADE;
